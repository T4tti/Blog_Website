    ...
    try {
        ...
        if (isset($_POST['submit_info'])) {
            ...
            if (!preg_match('/^(?=.*[!@#$%^&*(),.?":{}|<>])(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d!@#$%^&*(),.?":{}|<>]{8,}$/', $new_password)) {
                throw new Exception("Mật khẩu phải ít nhất 8 ký tự, gồm chữ, số và ký tự đặc biệt.");
            }
            ...
            <div class="tab-pane fade show active" id="info">
                <form method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="birth" id="birth" class="form-control" min="1900-01-01" max="<?php echo date('Y-m-d', strtotime('-16 years')); ?>" 
                    ...
                    <div class="mb-3">
                        ...
                        <select name="gender" id="gender" class="form-select">
                            ...
                            <option value="Nam" <?php echo $_SESSION['gender'] === 'Nam' ? 'selected' : ''; ?>>Nam</option>
                            <option value="Nữ" <?php echo $_SESSION['gender'] === 'Nữ' ? 'selected' : ''; ?>>Nữ</option>
                            <option value="Khác" <?php echo $_SESSION['gender'] === 'Khác' ? 'selected' : ''; ?>>Khác</option>
                        </select>
                    </div>
                    <button type="submit" name="submit_info" class="btn btn-success">Cập nhật</button>
                    <button type="button" class="btn btn-danger" onclick=" window.location.href = '../layouts/profile.php'" >Hủy bỏ</button>
                </form>
            </div>
            ...
            <div class="tab-pane fade" id="password">
                <form method="POST" id="frm-pwd">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="error-conf" class="custom-error" role="alert" aria-live="polite" style="display: none;">
